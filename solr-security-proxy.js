...
//	console.log("inbound url: "+parsedUrl.pathname)
//	console.log("whitelist urls: "+options.validPaths.toString().split(","))
...
if (require.main === module) {
  ...
  var options = {
    ...
    'backendPort':   { description: "Solr backend port", default: 8983},
    'backendHost':   { description: "Solr backend host", default: 'localhost'},
    'validPaths':     { description: "Only allow these paths (comma separated)", default: '/solr/.+,/favicon.ico'},
